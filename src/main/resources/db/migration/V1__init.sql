...
insert into contacts(id ,name, data) values ('295c4a70-f4ca-4e49-8cd7-3542c53f4925','PHONE','+7 (962) 595-73-09');
insert into contacts(id ,name, data) values ('57ebe16d-f03c-4042-8383-af34d6eb5797','TELEGRAM','@Vladimir_Ykm');
insert into contacts(id ,name, data) values ('2873a8ec-cbdd-4d3c-947f-f78d598862fc','E-MAIL','yakimovvn@bk.ru');
insert into contacts(id ,name, data) values ('5f90ff46-8310-498f-824c-cc4acdb1d056','ADDRESS','Moscow, Russia');
...
insert into jobs(name, title, work_date, description, responsibilities) values (
...
insert into languages(language_name) values ('Russian - native'),
                                            ('English - B1(intermediate), fluent');
...
insert into educations(education) values ('National Research Mordovian State University named after N.P. Ogarova, Saransk, Faculty of Electronic Engineering, Automated systems data processing and control. (2005 - 2010), Master');
